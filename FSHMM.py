...
from sklearn.utils import check_array, check_random_state   ### NEW: check_array ###
### NEW ###
from scipy.special import logsumexp

from hmmlearn import _utils, _hmmc   ### NEW: _hmmc ###
from hmmlearn.stats import log_multivariate_normal_density
from hmmlearn.base import BaseHMM
from hmmlearn.utils import fill_covars, log_normalize, normalize, iter_from_X_lengths   ### NEW: iter_from_X_lengths ###
    ...
    def fit(self, X, lengths=None):
            ...
            for iter in range(self.n_iter):
                ...
                for sub_X in _utils.split_X_lengths(X, lengths):
                  ...
                  ### NEW ###    
                  self.compute_FS_ESTEP(sub_X, posteriors)
...
class PoissonHMM(BaseHMM):
    ...
    def _do_mstep(self, stats):
        ...
        if 'l' in self.params:
            # Based on: HyvÃƒÆ’Ã‚Â¶nen & Tolonen, "Bayesian Inference 2019"
            # section 3.2
